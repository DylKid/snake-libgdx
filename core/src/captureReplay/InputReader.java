...
public class InputReader implements Runnable, Input {
  ...
  //  private RemoteInputListener listener;
    ...
    com.badlogic.gdx.InputProcessor processor = null;
   ...
   // public final String[] ips;
    ...
    public void run() {
        ...
        while(count < 1000){
            count++;
            sleep(100);
            System.out.println("INPUTREADER LOG");
        }*/
        ...
        try {
            ...
            //writer = new BufferedWriter(new FileWriter(stateFileName));
    ...
    private void writeObjectList(Object object, BufferedWriter writer){
    ...
    //TODO should go in a different class - this kind of logic needs to be generated by your program automatically
    /*private PositionList getSnakePositions() throws NoSuchFieldException, IllegalAccessException {
        GameScreen gameScreen = (GameScreen) game.getScreen();
        Field privateStringField = GameScreen.class.getDeclaredField("snake");
        privateStringField.setAccessible(true);
        Snake snake = (Snake) privateStringField.get(gameScreen);
        Field positionField = Snake.class.getDeclaredField("positions");
        positionField.setAccessible(true);
        PositionList positions = (PositionList) positionField.get(snake);
        return positions;
    }*/

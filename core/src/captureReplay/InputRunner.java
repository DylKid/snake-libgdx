...
public class InputRunner implements Runnable, Input {
  ...
  //  private RemoteInputListener listener;
    ...
    private FakeInput eventType;
    private int value;

    public void setEventType(FakeInput eventType){
    ...
    public void run() {
        ...
        switch(eventType){
            ...
            case WAIT:
                sleep(value);
                break;
            //Run it on the application thread
        }
        Gdx.app.postRunnable(new EventTrigger(touchEvent, keyEvent));
        //System.out.println(Gdx.input.isKeyJustPressed(value));
    }
